      ...
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div className="aria-font">
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            States, analytics cookies are set from your first pageview — and any visitor can turn
            them off at any time via the Cookie Preferences link in the footer. See our{' '}
