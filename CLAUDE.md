# Claude Code Instructions: FFC-IN-FFC_Single_Page_Template

Welcome, Claude! This document provides specific instructions for working on FFC-IN-FFC_Single_Page_Template.
...
pnpm run check:drift  # FFC best-practice enforcement (kebab-case routes, assetPath usage, CSP sync, secret patterns, placeholder URLs)
