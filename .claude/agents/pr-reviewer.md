...
You are reviewing a pull request on an FFC-supported nonprofit site built from `FFC-IN-FFC_Single_Page_Template`. The repo holds itself to these rules — your review should too.
